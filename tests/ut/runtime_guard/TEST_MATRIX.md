...
| V25* | — | detector placement / ExecScope | LPT balance, manual/pin, manager stage gating |

> Dropped from this branch (follow-up): V1 (`matched_layers`), V7 (`position_alignment`),
> V20/V22 (`KvBlockMetaTracker` write-meta), V24 (`slot_consistency`).
