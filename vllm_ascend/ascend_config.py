...
class AscendConfig:
    ...
    def __init__(self, vllm_config: "VllmConfig"):
        ...
        # Legacy pre-DFX dump knob; ignored — DFX JSON is the sole dump control plane.
        if "dynamic_dump_config" in additional_config:
            logger.warning(
                "additional_config.dynamic_dump_config is ignored; use DFX dump "
                "(auto_max_times / manual_dump) in dfx_config_path / dfx_config."
            )
