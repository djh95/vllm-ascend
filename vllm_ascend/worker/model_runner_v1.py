...
class NPUModelRunner(GPUModelRunner):
    ...
    def _execute_model_after_sync(
        ...
        """Body of execute_model after runtime_guard sync (sample-end flush)."""
    ...
    def sample_tokens(
        ...
        try:
            ...
            is_output_rank = True
        num_nans_kw = (
            {"num_nans": num_nans_device_capture} if nans_to_dict is not None else {}
        )
        if need_async_check and is_output_rank:
            ...
            # Feature-idle / non-TP0: skip AscendAsync wrapper (no post-sample check).
