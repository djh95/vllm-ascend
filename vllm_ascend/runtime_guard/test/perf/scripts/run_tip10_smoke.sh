...
PRODUCT=/data0/test-mrv2-cann91/rg-tip10-verify
MODEL=/data0/weights/DeepSeek-V2-Lite
ROOT=/data0/test-mrv2-cann91/rg_tip10_smoke
LOG=$ROOT/master.log
mkdir -p "$ROOT"
...
log "=== tip10 smoke start PRODUCT=$PRODUCT vllm029 tip=63918c8e3 cards=0,3 ==="
