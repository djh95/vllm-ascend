...
def write_kv_dump_skipped_finished(
    ...
    *,
    ...
    """Compatibility wrapper → :func:`write_kv_dump_skipped` (finished/reaped)."""
    return write_kv_dump_skipped(
        dump_root,
        req_id=req_id,
...
def write_kv_dump_arm_failed(
    ...
    *,
    ...
    """Compatibility wrapper → :func:`write_kv_dump_skipped` (arm stage)."""
    return write_kv_dump_skipped(
        dump_root,
        req_id=req_id,
        incident_type=incident_type,
