...
"""Config-backed anomaly detectors (knobs under ``runtime_config.detector.<section>``)."""
...
class ConfigBackedDetector(AnomalyDetector):
    ...
    def refresh_from_config(self) -> None:
        """Pull enable + knobs from live ``runtime_config.detector.<section_key>``."""
