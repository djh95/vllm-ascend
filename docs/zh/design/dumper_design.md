...
Detect 输入过滤见 [dfx_design.md](./dfx_design.md) §2.6 / [dfx_ops.md](./dfx_ops.md) §2.4（`manual_dump` / `ManualTriggerManager` 不走过滤）。
...
| [dfx_ops.md](./dfx_ops.md) | 运维与排障（含 ACLGraph / `manual_dump`） |
